function Compare-IntuneGroupAssignment {
    ...
    $categories = [ordered]@{
        ...
        "Windows Feature Update Profiles"     = "WindowsFeatureUpdates"
        "Windows Quality Update Profiles"     = "WindowsQualityUpdates"
        "Windows Driver Update Profiles"      = "WindowsDriverUpdates"
        "Windows Quality Update Policies"     = "WindowsQualityUpdatePolicies"
